...
public class Gizmo extends Component{
    ...
    public void start() {
        ...
        this.xAxisObject.transform.zIndex = (int)1e23;
        this.yAxisObject.transform.zIndex = (int)1e23;
        this.xAxisObject.nonSerializeable();
        this.yAxisObject.nonSerializeable();
    }
